...
module.exports = {
    ...
    'facebookAuth' : {
        ...
        'callbackURL'   : 'http://trych-env.us-east-1.elasticbeanstalk.com/auth/facebook/callback'
    },

    'twitterAuth' : {
        'consumerKey'       : 'L1LZASfV55TdcKgp5PiXHQvt8',
        'consumerSecret'    : 'ObQVZ7jlVz8cHiV2W3nELaQZhAgAr1Q2mU8AJ98W2ZZGEVwvcb',
        'callbackURL'       : 'http://trych-env.us-east-1.elasticbeanstalk.com/auth/twitter/callback'
    },

    'googleAuth' : {
        'clientID'      : '668415300177-24gqu1umtos6a5o19f7ve4kn9fri00bl.apps.googleusercontent.com',
        'clientSecret'  : '0IgohWAvHMWSw1_1aCqqM6Nk',
        'callbackURL'   : 'http://trych-env.us-east-1.elasticbeanstalk.com/auth/google/callback'
    }
